 ...
 */
final class Version20230701091641 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE figure CHANGE email_id user_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE figure CHANGE user_id email_id INT NOT NULL');
    }
}
